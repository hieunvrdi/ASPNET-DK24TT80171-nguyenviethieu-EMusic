...
{
    /// <inheritdoc />
    public partial class AddSongArtistAndAlbumArtist : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Data migration: populate join tables from existing primary FK data
            migrationBuilder.Sql(@"
                INSERT INTO SongArtists (SongId, ArtistId, [Order])
                SELECT Id, ArtistId, 0 FROM Songs;

                INSERT INTO AlbumArtists (AlbumId, ArtistId, [Order])
                SELECT Id, ArtistId, 0 FROM Albums;
            ");
        }
